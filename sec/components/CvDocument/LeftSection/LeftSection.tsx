    ...
    <View style={[styles.container]}>
      ...
      <LeftSectionPanel title={'Contact'}>
        <View style={styles.contactItemLine}>
          <Svg width="14px" height="14px" style={styles.icon}>
          ...
          <Text contrast>(+40) 751 077 097</Text>
        </View>
        ...
        <View style={styles.contactItemLine}>
          ...
          <Text contrast>Cluj-Napoca, Romania</Text>
        </View>
        ...
        <View style={styles.contactItemLine}>
          ...
          <Text contrast>radu@nemerenco.com</Text>
        </View>
        ...
        <View style={styles.contactItemLine}>
          ...
          <Text contrast>in/radunemerenco</Text>
        </View>
        ...
        <View style={styles.contactItemLine}>
          ...
          <Text contrast>r.nemerenco</Text>
        </View>
