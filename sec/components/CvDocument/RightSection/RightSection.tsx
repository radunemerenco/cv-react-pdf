  ...
  return (
    <View style={[styles.container]}>
      ...
      <ProjectCard
        ...
        achievements={[
          <><Text isBold>Increased reachability</Text> in less favored areas <Text isBold>by more than 30%</Text> by designing a simple yet rich web and mobile app where people connect with specialists in law and justice.</>,
          <><Text isBold>Reduced the costs and time of development by 3X</Text> by implementing a React Native codebase that will deploy on iOS, Android and WEB at the same time.</>,
          <><Text isBold>Increased the user base by 25%</Text> by improving the accessibility with a record audio functionality that allows the users to describe their problems with voice together with text.</>,
        ]}
      ...
      <ProjectCard
        ...
        achievements={[
          <><Text isBold>Secured investments worth over €500k</Text> in less than 6 months by catching potential investors trust and attention by building a highly-intuitive MVP.</>,
          <><Text isBold>Amassed more than 5k paying users bringing over €20k</Text> in monthly earnings in less than one year by designing an algorithm that automatically matches trucks to loads and improves the performance of the dispatcher</>,
          <>Boosted the development and deployment processes <Text isBold>by more than 3x</Text> their initial speed by including the Code of Conduct for the development department and automating the CI/CD pipelines</>
        ]}
      ...
      <ProjectCard
        ...
        achievements={[
          <><Text isBold>Secured 5 profitable contracts worth over $500K</Text> by accurately identifying clients needs and designing and implementing POCs that were generating profits in the pilot phases.</>,
          <><Text isBold>Improved customer retention by 25%</Text> and <Text isBold>increased the number of signed contracts by 3x</Text> on the strength of engaging AI to replicate the human stylist and designing a SAAS and presenting the recommendations directly on the product pages.</>,
        ]}
      ...
      <ProjectCard
        ...
        achievements={[
          <><Text isBold>Improved the reporting process by 10X</Text> by designing a system that automatically collects public data from multiple sources and countries and presents the information and entity relations in a human readable way.</>,
          <><Text isBold>Increased the reporting precision by 20%</Text> by designing a system that collects the public articles and identifies the emotional level in the context related to the entities and persons of interest.</>,
        ]}
      ...
      <ProjectCard
        ...
        achievements={[
          <><Text isBold>Increase the internal processes performance by 20%</Text> by designing an intermediary solution that will update the project task status based on the statuses of the attached documents.</>,
          <><Text isBold>Ensured 100% synchronisation accuracy</Text> by replacing entirely the human interaction in the process.</>,
        ]}
