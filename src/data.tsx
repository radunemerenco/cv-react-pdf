...
export const projectsByName = {
  ...
  vinnVinn: {
    ...
    achievements: [
      <><Text isBold>Significantly reduced customer waiting time by more than 60%</Text> and <Text>increased the in store sales by more than 10%</Text> by designing a system that will localise the client’s position in store and notify the targeted specialists instantly.</>,
    ],
